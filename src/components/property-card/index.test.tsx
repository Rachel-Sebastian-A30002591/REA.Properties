...
it('renders without crashing with action button as Add', () => {
  ...
  ReactDOM.render(< PropertyCard property={property} type={PropertyTypes.Add} actionButton={true}
    onActionClick={handleClick}></PropertyCard >, div);
  ReactDOM.unmountComponentAtNode(div);
});

it('renders without crashing without action button as Add', () => {
  const div = document.createElement('div');
  ReactDOM.render(< PropertyCard property={property} type={PropertyTypes.Add} actionButton={false}
    onActionClick={handleClick}></PropertyCard >, div);
  ReactDOM.unmountComponentAtNode(div);
});
...
it('renders without crashing with action button as Remove', () => {
  const div = document.createElement('div');
  ReactDOM.render(< PropertyCard property={property} type={PropertyTypes.Remove} actionButton={true}
    onActionClick={handleClick}></PropertyCard >, div);
  ReactDOM.unmountComponentAtNode(div);
});
...
it('Test click event Add', () => {
  ...
  const button = shallow((< PropertyCard property={property} type={PropertyTypes.Add} actionButton={true}
    onActionClick={handleClick}></PropertyCard >));
...
it('Test click event Add', () => {
  const mockCallBack = jest.fn();
  const button = shallow((< PropertyCard property={property} type={PropertyTypes.Remove} actionButton={true}
    onActionClick={handleClick}></PropertyCard >));
  button.find('button').simulate('click');
  expect(mockCallBack.mock.calls.length).toEqual(0);
});