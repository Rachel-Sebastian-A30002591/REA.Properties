...
const PropertyCard: React.FC<Props> = ({
  ...
  return (
    <div className="card card-1">
      <div
        className="card-top-conatiner d-flex justify-content-between"
      ...
      >
        ...
        <div className="card-title">
          <span className="badge badge-light">ID: {property.id}</span>
        </div>
      </div>
      ...
      />
      <div className="price d-flex align-items-center justify-content-center p-1 w-100">
        {property.price}
      </div>
      {actionButton === true ? (
        <div className="d-flex align-items-center justify-content-center p-1 w-100 action-button">
          {type === PropertyTypes.Add ? (
            <button
              type="button"
              className="btn btn-primary rounded-pill w-75"
              onClick={() => onActionClick(PropertyTypes.Add, property)}
            >
              Add Property
            </button>
          ) : (
            <button
              ...
              onClick={() => onActionClick(PropertyTypes.Remove, property)}
            >
              Remove Property
            </button>
          )}
